...
- **🚀 Live Demo**: [her-driver-test.vercel.app](https://her-driver-test.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/her-driver-test)
...
1. `git clone https://github.com/blefnk/her-driver-test.git`
2. `cd her-driver-test`
3. `bun i`
